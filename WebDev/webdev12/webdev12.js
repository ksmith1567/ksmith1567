    ...
    for (let i = 0; i < config.particleCount; i++) {
        ...
        for (let k = 0; k < config.particleCount; k++) {
            ...
            switch(config.colorScheme) {
                case 'pink': hue = Math.random() * 20 + 310; break;
                case 'purple': hue = Math.random() * 20 + 260; break;
                case 'blue': hue = Math.random() * 20 + 210; break;
                case 'orange': hue = Math.random() * 20 + 15; break;
